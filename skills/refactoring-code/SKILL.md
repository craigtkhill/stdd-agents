...
See [STRATEGIES.md](STRATEGIES.md) for the full list of strategies with When/Action/Benefit.
...
See [STRATEGIES.md](STRATEGIES.md) for the full list of anti-patterns.
